 ...
 |  """
    ...
    def get_ascii_fruit(self):
        ...
        if self._fruit % TREE_LEAVES_PER_ROW > 0:
            ...
            result += "\n"
        for _ in range(self._fruit // TREE_LEAVES_PER_ROW):
            result += "." * TREE_LEAVES_PER_ROW
            result += "\n"
        return result
    ...
    def grow(self, sunlight, water):
        ...
        fruit_grow_chance = random.randint(1, 2)
        fruit_loss_chance = random.randint(1, 5)
        self._fruit += random.randint((fruit_grow_chance - fruit_loss_chance), sunlight)
